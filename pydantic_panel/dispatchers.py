...
from panel.widgets import ( LiteralInput, IntInput, NumberInput, DatetimePicker, 
                    Checkbox, TextInput, TextAreaInput, ArrayInput, Select )
...
def get_widget(value: Integral, field: Any, **kwargs):
    ...
    return IntInput(value=value, start=start,
                               end=end, **kwargs)
...
def get_widget(value: Number, field: Any, **kwargs):
    ...
    return NumberInput(value=value, start=start,
                                  end=end, **kwargs)
